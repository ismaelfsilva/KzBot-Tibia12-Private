...
namespace KzBot.UI
{
    public partial class Refill : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            Globals.ScriptConfig.Refill.Add(rule);
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RefillRule rule = Globals.ScriptConfig.Refill[listView1.SelectedIndices[0]];
        ...
        private void deleteToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Globals.ScriptConfig.Refill.RemoveAt(listView1.SelectedIndices[0]);
        ...
        private void knightToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Globals.ScriptConfig.Refill.Add(rule2);
            ...
            Globals.ScriptConfig.Refill.Add(rule3);
        ...
        private void paladinToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            Globals.ScriptConfig.Refill.Add(rule6);
            ...
            Globals.ScriptConfig.Refill.Add(rule5);
            ...
            Globals.ScriptConfig.Refill.Add(rule4);
